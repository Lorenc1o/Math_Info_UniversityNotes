...
public class Problem2Bodies implements InitialValueProblem {
	...
	public static void main(String[] args) {
        ...
        /*
        RichardsonAdaptativeMethod rk4R = new RK4Richardson(problem,h,1e-8,2,1e-1);
        
        if (true) {
        	rk4R.solve(8760);
        	NumericalSolutionPoint last = rk4R.getSolution().getLastPoint();
        	last.println();
        }*/
		...
		//DisplaySolution.statePlot(rk4R.getSolution(), 0, 1, (int)Math.round(nyears/h));
	}
