...
public class Taylor1DExample implements InitialValueProblem {
    ...
    static public class Taylor1DExample2ndOrderSolver extends FixedStepMethod {
        ...
        public Taylor1DExample2ndOrderSolver(InitialValueProblem problem, double step, Event e) {
    ...
    static public class Taylor1DExample4thdOrderSolver extends FixedStepMethod {
        ...
        public Taylor1DExample4thdOrderSolver(InitialValueProblem problem, double step, Event e) {
            super(problem, step,e);
        }
    ...
    public static void main(String[] args) {
        ...
        Event taylorEvent = new Event(1e-5, 0) {
        ...
        FixedStepMethod taylor2Method = new Taylor1DExample2ndOrderSolver(problem,h,taylorEvent);
        FixedStepMethod taylor4Method = new Taylor1DExample4thdOrderSolver(problem,h,taylorEvent);
        FixedStepMethod eulerMethod     = new FixedStepEulerMethod (problem,h,taylorEvent);
        FixedStepMethod eulerHalfMethod = new FixedStepEulerMethod (problem,h/2,taylorEvent);

        eulerMethod.solve(maxTime);
        taylorEvent.reset_stopComputation();
