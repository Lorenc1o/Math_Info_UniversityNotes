...
%         Admite .huc
%   extension: Un string indicando la extensión del archivo, "bmp" o "png"
%   en mi caso
...
nombrecomp=strcat('Images/DecodedCustom/',extension,'/',nomb(1), '_cali', nomb(2), '_des_cus.',extension);
fid = fopen(fname,'r');
